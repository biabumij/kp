                        ...
                        <div class="panel-content">
                            <div class="row">
                                ...
                                <div class="col-sm-12 text-right">
                                    <a href="<?= base_url('admin/produk') ?>" class="btn btn-info" style="font-weight:bold; border-radius:10px;"><i class="fa fa-arrow-left"></i> Kembali</a>
                                    <?php
                                    if($this->session->userdata('admin_group_id') == 1 || $this->session->userdata('admin_group_id') == 2){
                                        ...
                                        <a  href="<?= base_url('produk/buat_baru/'.$row['id']) ?>" class="btn btn-primary" style="font-weight:bold; border-radius:10px;"><i class="fa fa-edit"></i> Ubah</a>
                                        <?php
                                    }
                                    ?>
