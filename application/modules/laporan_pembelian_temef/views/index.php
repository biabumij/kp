...
<body>
    <div class="wrap">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div style="margin: 20px">
                                                                <div class="row">
                                                                    <form action="<?php echo site_url('laporan/cetak_penerimaan_pembelian_temef'); ?>" target="_blank">
                                                                        <div class="col-sm-3">
        ...
        function PenerimaanPembelian() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('pmm/receipt_material/penerimaan_pembelian_temef'); ?>/" + Math.random(),
                dataType: 'json',
                data: {
