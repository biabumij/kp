	...
	<body>
		...
		<table cellpadding="4" width="98%">
			...
			<tr class="table-baris1-bold">
				...
				<td align="right"><?php echo number_format($nilai_penerimaan_pembelian_temef_all,0,',','.');?></td>
	        </tr>
			<tr class="table-baris1-bold">
				<td align="left">2.</td>
				<td class="text-left">SC</td>
				<td align="right"><?php echo number_format($nilai_penerimaan_pembelian_sc,0,',','.');?></td>
				<td align="right"><?php echo number_format($nilai_penerimaan_pembelian_sc_all,0,',','.');?></td>
	        </tr>
			<tr class="table-total">
				...
				<td align="right"><?php echo number_format($nilai_penerimaan_pembelian_temef_all + $nilai_penerimaan_pembelian_sc_all,0,',','.');?></td>
	        </tr>
		</table>
	</body>
</html>