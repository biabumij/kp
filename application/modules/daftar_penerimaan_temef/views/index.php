...
<body>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div style="margin: 20px">
                                                                <div class="row">
                                                                <form action="<?php echo site_url('laporan/cetak_daftar_penerimaan_temef'); ?>" target="_blank">
                                                                    <div class="col-sm-3">
    ...
    <script type="text/javascript">
        ...
        function DaftarPenerimaan() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('pmm/productions/daftar_penerimaan_temef'); ?>/" + Math.random(),
                dataType: 'json',
                data: {
