...
<body>
    <div class="wrap">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div style="margin: 20px">
                                                                <div class="row">
                                                                    <form action="<?php echo site_url('laporan/cetak_daftar_pembayaran_sc'); ?>" target="_blank">
                                                                        <div class="col-sm-3">
        ...
        function TableDaftarPembayaran() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('pmm/receipt_material/table_daftar_pembayaran_sc'); ?>/" + Math.random(),
                dataType: 'json',
                data: {
