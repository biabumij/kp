	...
	<body>
		<table width="98%">
			<tr>
				<td width="100%" align="center">
				    ...
				    <div style="display: block;font-weight: bold;font-size: 10px;">DIVISI STONE CRUSHER</div>
		...
		<table cellpadding="4" width="98%">
			<tr class="table-judul">
				...
				<th align="left" width="20%">NO. TRANSAKSI</th>
				<th align="left" width="20%">TANGGAL TAGIHAN</th>
				<th align="left" width="20%">NO. TAGIHAN</th>
				<th align="right" width="15%">PEMBAYARAN</th>
            </tr>
            <?php   
            if(!empty($data)){
            	foreach ($data as $key => $row) {
            		...
            		foreach ($row['mats'] as $mat) {
            			...
            			<tr class="table-baris1">
							...
							<td align="left"><?php echo $mat['tanggal_invoice'];?></td>
