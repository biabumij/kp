                        ...
                        <div class="panel">
                                ...
                                <h3 class="section-subtitle">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <ul class="dropdown-menu">
											<li><a href="<?= site_url('satuan/form'); ?>">Buat Satuan</a></li>
                                        </ul>
                                    </div>
                                </h3>
                            ...
                            <div class="panel-content">
                                <ul class="nav nav-tabs" role="tablist">
									<li role="presentation" class="active"><a href="#satuan" aria-controls="satuan" role="tab" data-toggle="tab">Satuan</a></li>
                                </ul>
                                            ...
                                            <table class="table table-striped table-hover" id="table_satuan" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="85%" class="text-center">Satuan</th>
