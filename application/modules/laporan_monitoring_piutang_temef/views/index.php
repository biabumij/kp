    ...
    <div class="wrap">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="pembelian">
                                        ...
                                        <div class="row">
                                            <?php
                                                ...
                                                $status_pembayaran = $this->db2->group_by('status_pembayaran', 'asc')->get_where('pmm_penagihan_penjualan')->result_array();
                                            ?>
                                            <div width="100%">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div style="margin: 20px">
                                                                <div class="row">
                                                                    <form action="<?php echo site_url('laporan/cetak_monitoring_piutang_temef'); ?>" target="_blank">
                                                                        <div class="col-sm-3">
        ...
        <script type="text/javascript">
            ...
            function LaporanMonitoringPiutang() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('pmm/productions/monitoring_piutang_temef'); ?>/" + Math.random(),
                    dataType: 'json',
                    data: {
