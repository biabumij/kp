...
<body>
    <div class="wrap">
                        ...
                        <div class="panel" style="background: linear-gradient(90deg, #f8f8f8 20%, #dddddd 40%, #f8f8f8 80%);">
                            <div class="panel-content">
                                ...
                                <div class="tab-content">
                                            ...
                                            <div width="100%">
                                                <div class="panel panel-default">
                                                    <div class="col-sm-5">
                                                        ...
                                                        <a href="#laporan_laba_rugi" aria-controls="laporan_laba_rugi" role="tab" data-toggle="tab" class="btn btn-primary" style="font-weight:bold; border-radius:10px;">Lihat Laporan</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Laporan Laba Rugi -->
                                    <div role="tabpanel" class="tab-pane" id="laporan_laba_rugi">
                                        <div class="col-sm-15">
										    <div class="panel panel-default">
												...
												<div style="margin: 20px">
													<div class="row">
														<form action="<?php echo site_url('laporan/cetak_laba_rugi_int');?>" target="_blank">
															<div class="col-sm-3">
        ...
        function LabaRugi()
        {
            ...
            $.ajax({
                type    : "POST",
                url     : "<?php echo site_url('pmm/reports/laba_rugi_int'); ?>/"+Math.random(),
                dataType : 'html',
                data: {
