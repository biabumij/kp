		...
		<table width="98%" border="0" cellpadding="15">
			<tr>
				<td width="100%" align="center">
					<div style="display: block;font-weight: bold;font-size: 10px;">MONITORING HUTANG</div>
				    <div style="display: block;font-weight: bold;font-size: 10px;">DIVISI BETON PROYEK BENDUNGAN TEMEF</div>
					<?php
					...
					?>
					<div style="display: block;font-weight: bold;font-size: 10px; text-transform: uppercase;">Per <?= tgl_indo(date($date2)); ?></div>
				</td>
			</tr>
		</table>	
