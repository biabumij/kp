...
<body>
    <div class="wrap">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div style="margin: 20px">
                                                                <div class="row">
                                                                    <form action="<?php echo site_url('laporan/cetak_monitoring_hutang_temef'); ?>" target="_blank">
                                                                        <div class="col-sm-3">
        ...
        function LaporanMonitoringHutang() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('pmm/receipt_material/monitoring_hutang_temef'); ?>/" + Math.random(),
                dataType: 'json',
                data: {
