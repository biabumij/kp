                                ...
                                <div class="panel-content">
                                    <form id="form-product" class="form-horizontal" action="<?php echo site_url('pengadaan/product_process'); ?>" >
                                        ...
                                        <div class="row">
                                            ...
                                            <br />
                                            <div class="col-sm-2">
                                                <button type="submit" class="btn btn-warning" id="btn-form"><i class="fa fa-send"></i> Tambah</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal" style="padding: 0 10px 0 20px;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="tanggal_permintaan" name="tanggal_permintaan" class="form-control" required="" autocomplete="off" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Total</label>
