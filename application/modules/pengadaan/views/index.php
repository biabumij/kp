...
<body>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-content">
                                <ul class="nav nav-tabs" role="tablist">
									<li role="presentation" class="active"><a href="#pengadaan" aria-controls="pengadaan" role="tab" data-toggle="tab">Pengadaan</a></li>
                                </ul>
	...
	$('#filter_date_pengadaan').daterangepicker({
		...
		var table_pengadaan = $('#table_pengadaan').DataTable({
            ajax: {
                processing: true,
                serverSide: true,
