    ...
    <div class="wrap">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div style="margin: 20px">
                                                                <?php
                                                                $product = $this->db3->order_by('nama_produk', 'asc')->get_where('produk', array('status' => 'PUBLISH'))->result_array();
                                                                $client = $this->db3->order_by('nama', 'asc')->get_where('penerima', array('status' => 'PUBLISH', 'pelanggan' => 1))->result_array();
                                                                ?>
                                                                <div class="row">
                                                                    <form action="<?php echo site_url('laporan/cetak_pengiriman_penjualan_sc'); ?>" target="_blank">
                                                                        <div class="col-sm-3">
                                                                            <input type="text" id="filter_date_a" name="filter_date" class="form-control dtpicker" value="<?php echo $_GET['filter_date'];?>" autocomplete="off" placeholder="Filter By Date">
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                ...
                                                                <div id="box-print" class="table-responsive">
                                                                    ...
                                                                    <table class="table table-hover table-center table-bordered" id="table-penjualan" style="display:none;">
                                                                        <thead>
                                                                            <tr class="judul">
        ...
        <script type="text/javascript">
            ...
            function TablePenjualan() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('pmm/productions/table_date_lap_penjualan_sc'); ?>/" + Math.random(),
                    dataType: 'json',
                    data: {
