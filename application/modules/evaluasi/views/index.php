...
<body>
                        ...
                        <div class="panel" style="background: linear-gradient(90deg, #f8f8f8 20%, #dddddd 40%, #f8f8f8 80%);">
                            ...
                            <div class="panel-content">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#supplier" aria-controls="supplier" role="tab" data-toggle="tab" style="font-weight:bold; border-radius:10px 0px 10px 0px;">Evaluasi Supplier</a></li>
                                </ul>
	...
	$('#filter_date_evaluasi_supplier').daterangepicker({
